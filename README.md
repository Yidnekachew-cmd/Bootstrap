...
> This project includes html files to build a portfolio using bootstrap framework.

**[Bootstrap Portfolio]** is our first portfolio using bootstrap.
...
- git clone git@github.com:Yidnekachew-cmd/Bootstrap.git
